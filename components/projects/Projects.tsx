...
const projects: Project[] = [
  {
    ...
    description:
      'Full-stack ownership of an enterprise LMS product — implementing pixel-perfect responsive UIs from designer specs, building RESTful microservices in Python, and managing MongoDB data layers.',
    ...
    details: {
      overview:
        'Perfect Learning is a large-scale Learning Management System built at Cyber Square AI & Robotics. I own full-stack development — from pixel-perfect React/Angular UIs to Python microservices and MongoDB data architecture, all deployed on AWS.',
      role: 'Python Full Stack Developer · Cyber Square AI & Robotics · Jan 2023 – Present',
      highlights: [
        'Led the migration of 90% of legacy APIs from Python 2 to Python 3, improving system performance, security compliance, and long-term scalability.',
        'Optimised complex database queries and backend workflows, achieving a 20% reduction in page load times.',
        'Designed and integrated Google Image Search using Google Programmable Search Engine and Custom Search JSON API.',
        'Implemented SonarQube for static code analysis, technical debt monitoring, and continuous code quality enforcement.',
        'Built modules including User Dashboard, Course Materials, Bookmarks, Practice Tests, and Analytics Dashboard.',
        'Actively contributed to sprint planning, backlog grooming, and agile ceremonies.',
        'Mentored junior developers through technical guidance, code reviews, and knowledge sharing.',
      ],
    },
  },
  {
    ...
    description:
      'End-to-end competitive quiz platform with dynamic question banks, real-time scoring, and leaderboards. Containerised with Docker and deployed on AWS ECS.',
    tech: ['Python', 'Flask', 'React', 'MongoDB', 'AWS', 'Docker', 'REST API'],
    ...
    details: {
      overview:
        'Mystery Matrix is a competitive quiz platform built with a scalable microservices architecture. It handles real-time leaderboards, background processing via cron jobs, and dynamic question banks — all containerised and cloud-deployed for high availability.',
      role: 'Full-Stack Developer · Personal Project',
      highlights: [
        'Designed a scalable microservices-based architecture for leaderboard cron jobs and background processing.',
        'Containerised all services using Docker and deployed to AWS ECS for environment parity and easy scaling.',
        'Engineered the system to support up to 7,000 concurrent users without performance degradation.',
        'Implemented REST APIs for secure, stateless client-server communication.',
        'Built a real-time scoring engine with dynamic leaderboard updates.',
        'Integrated MongoDB for flexible question bank storage and fast query performance.',
      ],
    },
  },
  {
    ...
    description:
      'A fully responsive learning platform frontend built in days by strategically leveraging AI tooling to compress the development cycle without compromising quality.',
    ...
    details: {
      overview:
        'A personal project exploring AI-augmented development velocity. The goal was to build a production-quality responsive learning platform frontend significantly faster than traditional timelines by strategically integrating AI tooling at every stage of the development cycle.',
      role: 'Solo Developer · Personal Project',
      highlights: [
        'Designed and built a complete responsive learning platform UI using AI-driven product ideation and Claude.',
        'Implemented clean component architecture with dynamic content modules and progress tracking.',
        'Compressed a multi-week development cycle to days without sacrificing code quality or UX.',
        'Demonstrated the practical velocity gains of AI-augmented engineering in a real product context.',
        'Served as a live proof-of-concept for AI-accelerated solo product development.',
      ],
    },
  },
  {
